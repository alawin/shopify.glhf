 ...
 * Bundled with esbuild into theme/assets/hero-3d.js (see package.json build:theme).
 */
...
function initHero(root) {
  ...
  // NB: data-enable-3d does NOT camelCase to dataset.enable3d (digit after hyphen)
  const use3d =
    root.getAttribute('data-enable-3d') === 'true' &&
    supportsWebGL() &&
  ...
  teardowns.push(initTimeline(root, progress));
